...
def run_simulation(ship_layout: list[list[int]], bot,
                   alien_positions: list[tuple[int, int]], is_show_tkinter: bool = False) -> \
        tuple[int, Status]:
...
def run_simulations_over_krange(ship_dim: int, krange: list[int], sampling_index: int, time_constraint: float,
